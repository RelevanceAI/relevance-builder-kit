...
Markdown templates for consistent documentation. Use the right template when adding new content.
...
- Adding new use-case playbooks
- Capturing product or domain knowledge
- Authoring locale guidelines
- Setting up your local builds index

## See Also

- `build-kit/CLAUDE.md` -- build-kit hub
- `.claude/rules/DOC_RULES.md` -- documentation standards these templates enforce
